<div wire:ignore.self class="modal fade" id="showPriority" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="showPriorityModal" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-info">
                <h5 class="modal-title" id="showPriorityModal">MOSTRAR PRIORIDAD</h5>
            ...
            <div class="modal-body">
                <form>
                    ...
                    <div class="form-group ">
                        <label class="text-muted text-uppercase" for="updated_at">Tareas relacionadas con esta prioridad</label>
