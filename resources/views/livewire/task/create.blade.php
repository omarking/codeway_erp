            ...
            <div class="modal-body">
                <form>
                    ...
                    <div class="form-group">
                        ...
                        <select wire:model="statu_id" class="form-control @error('statu_id') is-invalid @enderror" name="statu_id" id="statu_id">
                    ...
                    <div class="form-group">
                        ...
                        <select wire:model="type_id" class="form-control @error('type_id') is-invalid @enderror"  name="type_id" id="type_id">
                    ...
                    <div class="form-group">
                        ...
                        <select wire:model="priority_id" class="form-control @error('priority_id') is-invalid @enderror"  name="priority_id" id="priority_id">
