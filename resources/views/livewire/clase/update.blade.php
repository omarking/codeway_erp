<div wire:ignore.self class="modal fade" id="updateClass" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="updateClassModal" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-success">
                <h5 class="modal-title" id="updateClassModal">MODIFICAR CLASE</h5>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-success" wire:click.prevent="update()">Actualizar Clase</button>
            </div>
        </div>
    </div>
</div>
