<div wire:ignore.self class="modal fade" id="updateStatus" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="updateStatusModal" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-success">
                <h5 class="modal-title" id="updateStatusModal">MODIFICAR ESTADO</h5>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-success" wire:click.prevent="update()">Actualizar Estado</button>
            </div>
        </div>
    </div>
</div>
